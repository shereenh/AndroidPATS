...
/**
 * Created by shereen on 11/2/2017.
 *
 * API used for autolocate
 *
 */
...
public class PlaceAPI {
    ...
    private static final String API_KEY = "AIzaSyDUXAYlWMiWxDRgnekL_3zYehT0Avz0N50";

    public ArrayList<String> resultList;

    //Must not be called on Main/UI thread since it is a network operation
